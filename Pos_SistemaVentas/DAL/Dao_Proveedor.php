...
class Dao_Proveedor extends Dao_General implements IDao_Proveedor{
  ...
  { 
    try
    {
       $vecr = parent::buscarRegistro('tbl_Proveedores', $buscardato);
       if ($vecr!= NULL)
       {
  ...
  { 
    ...
    {
     $Lista = array();    
     $Lista =  parent::buscarDatoLista('tbl_proveedores', $buscardato);
     return $Lista;
    }
 
    public function eliminarProveedor($datoEliminar) 
    {
      $result = parent::eliminarRegistro("tbl_proveedores", $datoEliminar);
      return $result;  
    }
}
