...
class Dao_Cliente extends Dao_General implements IDao_Cliente{
  ...
  { 
    try
    {
       $vecr = parent::buscarRegistro(Dao_Cliente::Source_Clientes, $buscardato);
       if ($vecr!= NULL)
       {
         $cliente = new Cliente();
  ...
  {
     $Lista = array();    
     $Lista =  parent::buscarDatoLista(Dao_Cliente::Source_Clientes, $buscardato);
     return $Lista;
  }
    public function eliminarCliente($datoEliminar) {
      $result = parent::EliminarRegistro(Dao_Cliente::Source_Clientes, $datoEliminar);
      return $result;  
    }
