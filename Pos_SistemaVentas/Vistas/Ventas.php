...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
   ...
   <?php         
	...
	$cambio=NULL;	
        ...
        if (filter_input_array(INPUT_POST)) 
        {
             ...
             {    
                    $grabar = false;
                    $mensajeError ='Cantidad'.' '.Mensajes::MensajeStock;	
             }
  ...
  <div id="container"> 
       <div id="header">    
            <img src="../resources/imagenes/Inicio.jpg" alt="" />
       </div>
  </div> 
                           ...
                           <tr>
                               <td align="center" colspan="2">
                                   <table border="0"   cellspacing="5">
                                        ...
                                        <tr>
                                           <td align="right">Seleccionar Cliente</td>
                                            <td align="left">
                                                <select name="SlClientes" id="SlClientes">
                                                        <?php $tamano = sizeof ($_SESSION['ListadoClientes']);
                                                        for($i=0; $i<$tamano; $i++){ ?>
                                                        <option value="<?php echo $_SESSION['ListadoClientes'][$i];  ?>"                        
                                                                      ><?php $i++; echo $_SESSION['ListadoClientes'][$i]; } ?>
                                                        </option>                             
                                                </select>
                                                <td align="right"><a href="Clientes.php"><img src="../resources/imagenes/NuevoCliente.png" alt=""/></a></td>
                                            </td>
                                        </tr>     
