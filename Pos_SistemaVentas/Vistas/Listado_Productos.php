...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <body>
   <div id="container"> 
      ...
      <form name="formProduct_List" action="Listado_Productos.php" method="post">
             ...
             <tr>
               ...
               <td width="127" height="37" align="right">
                   <a href="../Vistas/Productos.php">
                       <input type="button" style="border:1px solid #066; background:#066; height:45px; width:140px; color:#FFF; border-radius:3px; font-family: 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;" value="+ Agregar Producto" />
                   </a>
               </td>
             </tr>
        </table>
        ...
        <br></br>
          ...
          <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #033; color:#033;">
           ...
           <tr>
               <th colspan="7" align="center" height="55px" style="border-bottom:1px solid #033; background: #066; color:#FFF;"> Información Productos	</th>
           </tr>
             ...
             <?php
                  ...
                  foreach($vector_resultado as $lista => $valor){?>   
                     <tr align="center" style="height:25px">                                              
                       ...
                       <td style="border-bottom:1px solid #333;"> <?php echo $valor[6]; ?> </td>
                       <td style="border-bottom:1px solid #333;">
                           <a href="../Vistas/Productos.php?id=<?php echo base64_encode($valor[0]);?>">
                           ...
                           <a href="../Form_Response/Response_Eliminar.php?id=<?php echo base64_encode($valor[0]);?>&accion=3">
