            ...
            <div id="popup-wrapper">
                <div id="popup-container">
                    ...
                    <table border="0" align="center">
                            <tr>
                                <td>Usuario *</td>
                                <td align="center"><input type="text" id="itUsername" name="itUsername" value="admin" placeholder="Usuario" required></td>
                            </tr>

                            <tr>
                                <td>Clave *</td>
                                <td align="center"><input type="password" id="itClave" value="admin" name="itClave" placeholder="Clave" required></td>
                            </tr>
