...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <?php       
        ...
        {              
            ...
            if ($datoBuscar != '')
            {
               header("Location: ../Vistas/Listado_Clientes.php?Buscar=$datoBuscar");        
            }         
         }
                  ...
                  <?php
                       ...
                       <tr align="center" style="height:25px">
                           ...
                           <td style="border-bottom:1px solid #333;">
                               ...
                               <a href="../Vistas/Clientes.php?id=<?php echo base64_encode($valor[0]);?>">
                               ...
                               <a href="../Form_Response/Response_Eliminar.php?id=<?php echo base64_encode($valor[0]);?>&accion=2">
